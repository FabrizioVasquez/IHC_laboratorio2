...
public class SceneManager : MonoBehaviour
{
    ...
    // We generate a new prefab for cube.
    ...
    private void TouchBegan(Touch touch)
    {
        ...
        // Elige un Prefab según el número aleatorio
        GameObject prefabToInstantiate = choice == 0 ? _ballPrefab : _cubePrefab;
        
        // Instancia el Prefab seleccionado
        GameObject newObject = Instantiate(prefabToInstantiate);
        newObject.transform.rotation = Quaternion.Euler(new Vector3(0.0f, 0.0f, 0.0f));
        newObject.transform.position = _mainCamera.transform.position + _mainCamera.transform.forward;

        // Añade una fuerza si el objeto tiene un componente Rigidbody
